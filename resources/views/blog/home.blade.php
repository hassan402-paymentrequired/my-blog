<x-layouts.app title="Hassan - blog">

    <div class="md:flex md:flex-col-reverse">
        <div class="flex items-center justify-center w-full p-2 mx-auto space-x-3 grow ">
            <livewire:filter-button title="programming" :active="true" />
            <livewire:filter-button title="general" :active="false" />
            <livewire:filter-button title="my career" :active="false" />
        </div>

        <div class="p-5 mt-5 grow">
            <h1 class="text-2xl font-bold md:text-7xl sm:text-3xl ">Hassan's Thoughts</h1>
        </div>
                        ...
                        <li class="relative flex flex-col items-start sm:flex-row xl:flex-row">
                            <div class="order-1 sm:ml-6 ">
                                <h3 class="mb-1 font-semibold text-slate-900">
                                    <span class="block mb-1 text-sm leading-6 text-indigo-500">{{ $post->tag ?? 'programming' }}</span><p>
                                        {{ $post->title }}</p>
                                </h3>

                                <a
                                    class="inline-flex items-center px-3 mt-6 text-sm font-semibold rounded-full group h-9 whitespace-nowrap focus:outline-none focus:ring-2 bg-slate-100 text-slate-700 hover:bg-slate-200 hover:text-slate-900 focus:ring-slate-500"
                            ...
                            <img src="https://tailwindcss.com/_next/static/media/headlessui@75.c1d50bc1.jpg"
                                alt=""
                                class="mb-6 shadow-md rounded-lg bg-slate-50 w-full sm:w-[17rem] sm:mb-0 xl:mb-6"
